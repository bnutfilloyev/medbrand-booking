    ...
    <>
      ...
      {doctor && <div className="about">
        ...
        <main className="about__main">
          <Section title="Tajriba" tag="experience">
            {doctor.experience}
          </Section>
          <Section title="Xizmatlar" tag="services">
            <ServicesList services={doctor.services}/>
          </Section>
          <Section title="Sertifikatlar" tag="certificates">
            {doctor.certificates}
          </Section>
          <Section title="Ish vaqti" tag="working-time">
            <WorkingHours hoursArray={workingHours}/>
          </Section>
          <Section title="Manzil" tag="location">
