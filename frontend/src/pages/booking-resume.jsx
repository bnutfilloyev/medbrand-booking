      ...
      <div className="resume">
        {userData && (
          <div className="resume__blocks">
            ...
            {diagnosticData && <ResumeBlock title="Sizning diagnostika tekshiruvingiz">
