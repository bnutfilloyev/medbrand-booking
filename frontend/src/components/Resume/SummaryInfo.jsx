...
const Resume = ({userData, selectedTimeSlot, selectedLocation, hoursArray}) => {
  ...
  return (<>
  <ResumeBlock title="Bemor ma’lumotlari">
    ...
    {selectedTimeSlot && (<>
  <ResumeBlock title="Sizning tashrifingiz">
        ...
        {selectedLocation && <>
          <div className="box">
            ...
            <a className="box__button button"
              ...
              target="_blank" rel="noopener noreferrer">Yo‘l ko‘rsatmalarini olish</a>
          </div>
        </>}
  <BoxWrap title="Ish soatlari">
